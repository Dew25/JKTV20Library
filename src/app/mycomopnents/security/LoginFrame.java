 ...
 */
package app.mycomopnents.security;
...
//    this.setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));
    ...
    EditorComponent loginComponent = new EditorComponent("Логин", 300, 27, 150);
    EditorComponent passwordComponent = new EditorComponent("Пароль", 300, 27, 150);
